...
public sealed class GenerationOutputAsset
{
    ...
    public bool HasGroundedEditorialMetadata =>
        EditorialMetadata?.Readiness ==
        ClipEditorialMetadataReadiness.GroundedDraft;
    public bool HasApprovedEditorialMetadata =>
        EditorialMetadata?.Readiness ==
        ClipEditorialMetadataReadiness.UserApproved;
    public bool HasUserEditedEditorialMetadata =>
        EditorialMetadata?.Readiness ==
    ...
    public bool IsEditorialMetadataCurrentForCut =>
        ...
        (EditorialMetadata.GroundingAudit is not { } audit ||
         audit.BriefFingerprint.Equals(
             EditorialContext.EditorialBrief.Fingerprint,
    ...
    private ClipEditorialTranscriptContext[] BuildCurrentCutTranscripts()
    {
        ...
        return RetainedCaptionEditorialTranscriptProjector.Project(
            Captions,
            SourceStart,
            SourceEnd);
    }
