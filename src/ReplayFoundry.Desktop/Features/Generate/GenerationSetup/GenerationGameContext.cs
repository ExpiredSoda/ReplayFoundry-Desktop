...
public sealed class GenerationSourceGameContext
{
    ...
    public bool IsUserGrounded => Origin is
    ...
    public GenerationSourceGameContext WithUserConfirmation(
        ...
        new(
            ...
            confirmedIdentity ??
                (ConfirmedIdentity?.CanonicalTitle.Equals(
                    gameName.Trim(),
    ...
    public static string SuggestedGameName(string sourceFullPath)
    {
        ...
        return GenerationGamePathHintPolicy.Suggest(sourceFullPath);
    }
...
public interface IGameKnowledgePermissionStatus
{
    event EventHandler? Changed;

    bool HasRememberedWikimediaPermission { get; }
}
