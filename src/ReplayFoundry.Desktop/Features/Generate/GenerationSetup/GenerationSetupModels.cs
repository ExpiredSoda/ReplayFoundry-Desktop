...
public enum GenerationMetadataAuthoringMode
{
    AiRequired,
    HeuristicOnly,
}
...
public sealed class GenerationSetupOptions
{
        ...
        GenerationDiscoveryIntent? discoveryIntent = null)
    {
        ...
        if (!Enum.IsDefined(metadataAuthoringMode))
        {
            throw new ArgumentOutOfRangeException(
                nameof(metadataAuthoringMode));
        }
        if (!Enum.IsDefined(
    ...
    public string MetadataAuthoringDisplayName =>
        MetadataAuthoringMode switch
        {
            GenerationMetadataAuthoringMode.AiRequired =>
                "Local AI titles",
            GenerationMetadataAuthoringMode.HeuristicOnly =>
                "Simple titles",
            _ => throw new InvalidOperationException(
                "The metadata authoring mode is not supported."),
        };
