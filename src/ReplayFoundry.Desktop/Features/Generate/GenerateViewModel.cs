...
public sealed class GenerateViewModel : IWorkspaceChromeSource, IDisposable,
    IGenerateWorkflowHost, IApplicationStopParticipant
{
        ...
        IRecentProjectsClearConfirmation? recentProjectsClearConfirmation = null)
    {
        ...
        _continueToGenerationSetupCommand = new AsyncDelegateCommand(
            ...
            () => CanEditSourceSelection() && HasSelectedSources);
        _openRecentProjectCommand = new AsyncDelegateCommand<RecentGenerationProject>(
        ...
        RecentGenerationProject project)
    {
            ...
            retained is not null)
        {
            StudioProjectSwitchResult result = _studioProjectSwitch is null
                ...
                : await _studioProjectSwitch.TrySwitchProjectAsync(retained);
        ...
        RecentProjectStatus =
            $"{project.Title} cannot be reopened in Studio. Its original " +
            "video may be missing or changed, or the project may have been " +
            "created in an older version of Replay Foundry. Nothing was " +
            "changed.";
    }
