        ...
        switch (update.Phase)
        {
            case MediaEvidenceAnalysisPhase.Preparing:
                progress.Report(Create(
                    ...
                    "Replay Foundry is preparing the full video and the areas you confirmed.",
                    source,
                    sourceNumber,
                    sourceCount,
            ...
            case MediaEvidenceAnalysisPhase.VisualIntervalPassCompleted:
                ReportBoundary(
                    ...
                    "Dark and still sections are ready.",
                    source,
                    sourceNumber,
                    sourceCount,
                    completedPasses: 2,
            ...
            case MediaEvidenceAnalysisPhase.AudioPassCompleted:
                {
                    ...
                    progress.Report(CreateBoundary(
                        ...
                        $"Audio track {update.StreamIndex} is ready.",
                        source,
                        sourceNumber,
                        sourceCount,
            ...
            case MediaEvidenceAnalysisPhase.Completed:
                progress.Report(CreateBoundary(
                    ...
                    "Replay Foundry has finished checking this video's picture and sound.",
                    source,
                    sourceNumber,
                    sourceCount,
                    totalPasses,
