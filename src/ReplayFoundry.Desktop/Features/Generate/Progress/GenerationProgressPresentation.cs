...
internal static class GenerationProgressPresentationFactory
{
    ...
    public static GenerationProgressPresentation BeginPreparation(
        ...
        Running(
            ...
            "Checking each selected video before clip setup.",
    ...
    public static GenerationProgressPresentation BeginEvidenceAnalysis(
        ...
        Running(
            ...
            "Replay Foundry is looking through each video and the areas you marked. Long recordings can take several minutes.",
            isIndeterminate: true);
        ...
        GenerationRequest request)
    {
        ...
        return Running(
            ...
            "Stop",
            "Getting ready",
            "Preparing your selected videos to find clips.",
            isIndeterminate: true);
    }
        ...
        GenerationProgressRunContext context)
    {
        ...
        return new GenerationProgressPresentation(
            ...
            "Your clips are ready to edit. Create the finished files from Studio when you are ready.",
