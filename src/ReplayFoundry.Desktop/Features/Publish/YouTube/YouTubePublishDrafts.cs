...
public sealed class InMemoryYouTubePublishDraftStore : IYouTubePublishDraftStore
{
    ...
    private IReadOnlyList<YouTubePublishDraft> _snapshot =
        Array.Empty<YouTubePublishDraft>();

    public IReadOnlyList<YouTubePublishDraft> Current => _snapshot;
    ...
    private void RefreshSnapshot() =>
        _snapshot = Array.AsReadOnly(_drafts.ToArray());
}
