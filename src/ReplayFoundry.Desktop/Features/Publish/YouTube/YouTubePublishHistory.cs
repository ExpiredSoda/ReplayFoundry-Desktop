    ...
    IYouTubePublishHistoryStore
{
    ...
    private IReadOnlyList<YouTubePublishHistoryEntry> _snapshot =
        Array.Empty<YouTubePublishHistoryEntry>();

    public IReadOnlyList<YouTubePublishHistoryEntry> Current => _snapshot;
    ...
    private void RefreshSnapshot() =>
        _snapshot = Array.AsReadOnly(_entries.ToArray());
}
