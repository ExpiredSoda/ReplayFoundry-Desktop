...
public sealed class UserReportCoordinator
{
    ...
    public StoredUserReport CaptureCrash(Exception exception)
    {
        ...
        UserReportDraft draft = CreateDraft(
            ...
            "Replay Foundry encountered an unexpected problem",
            "A sanitized local failure record is waiting for review. " +
        ...
        CancellationToken cancellationToken = default)
    {
            ...
            when (!cancellationToken.IsCancellationRequested)
        {
            ...
            return new UserReportSubmissionResult(
                ...
                "The report timed out while sending and remains in the local outbox.");
        }
