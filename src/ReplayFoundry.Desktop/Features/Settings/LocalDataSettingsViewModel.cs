...
public sealed class LocalDataSettingsViewModel : ObservableObject
{
    ...
    private async Task ClearCacheAsync()
    {
        ...
        Notice = result.Succeeded
            ? $"Deleted {FormatBytes(result.DeletedBytes)} of Studio previews, " +
              "game-search results, downloaded installer copies, and other temporary files. " +
              "Installed tools, AI models, projects, Library listings, and finished videos " +
              "were kept."
            : "Some temporary files were in use and could not be removed. " +
    ...
    private void ScheduleReset()
    {
        ...
        try
        {
            ...
            Notice =
                ...
                "and installed tools or AI models are never part of this reset.";
        }
    ...
    private void RefreshUsage()
    {
        ...
        CacheUsage = cache is null
            ? "Temporary file size unavailable"
