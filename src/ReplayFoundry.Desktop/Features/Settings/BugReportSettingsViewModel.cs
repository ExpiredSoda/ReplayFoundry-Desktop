...
public sealed class BugReportSettingsViewModel : ObservableObject, IDisposable
{
    ...
    public string DeliveryStatus => !IsAvailable
        ...
        : IsDeliveryAllowed
            ? IsDeliveryConfigured
                ...
                : "Sending allowed · support service unavailable"
            : "Sending off";
    public string DeliveryDetail =>
        IsDeliveryConfigured
            ? $"Support service: {_coordinator!.DestinationDisplayName}. " +
            ...
            : "The support service is not available, so reports cannot be sent. You can still review, keep, or delete them on this computer.";
    ...
    public string SelectedDiagnosticPreview => SelectedReport?.DiagnosticPreview ??
        "No support information is selected.";
    ...
    private void Enable()
    {
        ...
        {
            Notice = "Sending cannot be turned on because the support service is unavailable.";
            return;
        }
    ...
    private void DeleteAll()
    {
        ...
        OnPropertyChanged(nameof(DeleteAllLabel));
        RefreshReports();
        Notice = "All saved reports and their support information were deleted.";
    }
        ...
        _reports = _outbox?.Current.Select(static report =>
            new UserReportListItem(
                ...
                report.Draft.Attachments.Count == 0
                    ...
                    : $"{report.Draft.Attachments.Count} support information item{(report.Draft.Attachments.Count == 1 ? string.Empty : "s")}",
                report.Draft.Attachments.Count == 0
                    ? "No support information was included."
                    : string.Join(
