...
internal static class FfmpegPreviewCommandBuilder
{
        ...
        string outputPath)
    {
        ...
        [
            ...
            "error",
            "-y",
            .. request.WorkIntent == VideoPreviewWorkIntent.BackgroundFilmstrip ? new[] { "-threads", "1", "-filter_threads", "1" } : Array.Empty<string>(),
            "-ss",
            timestamp,
            "-i",
            ...
            "-c:v",
            "png",
            .. request.WorkIntent == VideoPreviewWorkIntent.BackgroundFilmstrip ? new[] { "-threads", "1" } : Array.Empty<string>(),
            "-compression_level",
            "6",
            outputPath,
        ],
