...
public partial class LocalDataCleanupConfirmationWindow : Window
{
    ...
    {
        ReplayFoundryLocalDataKind.DerivedCaches => "• Temporary files",
        ReplayFoundryLocalDataKind.DiagnosticsAndReports =>
            "• Troubleshooting logs and saved feedback or crash reports",
        ...
        ReplayFoundryLocalDataKind.LibraryCatalog =>
            "• Saved Library listings (video files remain on disk)",
