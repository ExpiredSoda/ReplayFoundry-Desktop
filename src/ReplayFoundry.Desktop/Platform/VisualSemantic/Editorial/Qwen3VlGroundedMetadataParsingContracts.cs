...
internal sealed record Qwen3VlGroundedMetadataEditorialFrame(
    string PolicyVersion,
    string AuthorityKind,
    Qwen3VlGroundedMetadataMomentKind MomentKind,
    string? Premise,
    IReadOnlyList<int> SupportingDraftOrdinals,
    bool CreatorAuthorityAdjusted)
{
    internal static Qwen3VlGroundedMetadataEditorialFrame Unclear(
        int primaryOrdinal) =>
        new(
            "grounded-editorial-frame-legacy",
            "StoryShapeOnly",
...
internal enum Qwen3VlGroundedMetadataPresentationKind
{
    InteractiveGameplay,
    CinematicSequence,
    InWorldRecording,
...
internal enum Qwen3VlGroundedMetadataMomentKind
{
    Action,
    Progress,
    Complication,
