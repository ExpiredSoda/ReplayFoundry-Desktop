    ...
    IDisposable
{
    ...
    internal const string PreviousEditorialFrameAdherenceOutputSchema =
        "grounded-editorial-metadata-output-batch-1.52";
    internal const string PreviousEditorialFramingOutputSchema =
        "grounded-editorial-metadata-output-batch-1.51";
    internal const string PreviousWholeBatchOutputSchema =
    ...
    internal const string PreviousCreatorVoicePromptSha256 =
        "4b63b0bf10b0123375eaa515232fcdc842e57b52f763147d07f9f22e4b6ea9fa";
    internal const string PreviousEditorialFramingPromptVersion = "1.38";
    internal const string PreviousEditorialFramingPromptSha256 =
        "5781731737b69188cf48dcd6bbaa1ca857d1989b6ac86b175248f2e0dcaba358";
    internal const string PreviousPromptVersion = "1.37";
    internal const string PreviousPromptSha256 =
        "e333a7282b666d48104dbf69ec0f924b51718e31e07b79c7705e26fe8ba74a73";
    internal const string EarlierPromptVersion = "1.36";
    internal const string EarlierPromptSha256 =
        "5315f5a2571e879bd8c8e3c73668b848b56d02cc8ba02beb0f9607534b767a96";
    internal const string PriorPromptVersion = "1.35";
    internal const string PriorPromptSha256 =
        "75582cb94e01a440dd139cacc4025a15ae82878252f84720c96b427e579d65aa";
    internal const string InitialPromptVersion = "1.34";
    internal const string InitialPromptSha256 =
        "1e0c0e2ed9413a890714c815d80ba6e161f08eea20130e742f3e50a666394a1a";
    internal const string BaselinePromptVersion = "1.33";
    ...
    internal const string PreviousEditorialFramingVisualEventSelectionSchemaVersion =
    ...
    internal const string VisualEventSelectionPromptVersion = "1.2";
    internal const string VisualEventSelectionPromptSha256 =
        "4d717bd549a6cdac1ab739aa129bb2628037666e876ffda7df68a6abc98aee35";
    internal const string PreviousEditorialFramingVisualEventSelectionPromptVersion =
        "1.1";
    internal const string PreviousEditorialFramingVisualEventSelectionPromptSha256 =
    ...
    internal const string GroundingPacketSchemaVersion =
        "grounded-editorial-grounding-packet-1.1";
    internal const string PreviousGroundingPacketSchemaVersion =
    ...
    internal const string ProviderVersion = "2.2.0";
    ...
    internal IReadOnlyList<ClipEditorialMetadataBatchOutcome> ParseOutcomes(
        string json,
        IReadOnlyList<ClipEditorialMetadataRequest> requests) =>
        Qwen3VlGroundedMetadataResultParser.ParseOutcomes(
            json,
            requests,
            _runtime,
            Identity);
    ...
    internal static void ValidateGenerationPassProvenance(
        ...
        bool editorialRephraseEligibilitySkipSupported = false,
        bool editorialRephraseEligibilitySkipped = false,
        ...
        Qwen3VlGroundedMetadataSelection.ValidateGenerationPassProvenance(
            ...
            editorialRephraseEligibilitySkipSupported,
