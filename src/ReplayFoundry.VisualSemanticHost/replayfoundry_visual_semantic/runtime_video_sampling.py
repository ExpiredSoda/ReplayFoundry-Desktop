"""Qualified runtime video-sampling verification."""
from __future__ import annotations

from .runtime_sampling_support import *  # noqa: F401,F403
...
def _verify_actual_pts_sampling(
    ...
    resize = resize_direct_frames or _resize_direct_frames_like_qwen
    compatible_resized = resize(
        direct_batch.data,
        video_element,
    )
