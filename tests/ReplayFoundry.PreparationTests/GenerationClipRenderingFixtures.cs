...
internal static partial class GenerationClipRenderingTests
{
    ...
    private sealed class PipelineFixture : IDisposable
    {
            ...
            GenerationMomentFindingResult moments)
        {
            ...
            EditorialMetadataResult = EditorialMetadata.GenerateAsync(
                    Moments,
                    captions: null,
        ...
        public IGenerationEditorialMetadataService EditorialMetadata { get; }
        public GenerationEditorialMetadataResult EditorialMetadataResult
        {
            get;
        }
