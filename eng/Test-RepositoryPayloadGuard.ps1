...
if (
    ...
    (
        Test-VisualSemanticSamplingRefreshPayloadPath (
            'src/ReplayFoundry.VisualSemanticHost/replayfoundry-visual-semantic-current-host-sampling-audit-refresh-policy-1.0.txt'
        )
    ) -or
    (
        Test-VisualSemanticSamplingRefreshPayloadPath (
    ...
    (
        Test-VisualSemanticPrompt2GeneratedPayloadFileName (
            'src/ReplayFoundry.VisualSemanticHost/replayfoundry-visual-semantic-editorial-development-gates-1.0.json'
        )
    ) -or
    -not (
